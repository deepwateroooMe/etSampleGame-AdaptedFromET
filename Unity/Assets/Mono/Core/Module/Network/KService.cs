...
namespace ET {
    ...
    public static class KcpProtocalType { // 几种不同的，消息类型
        public const byte SYN = 1;
        public const byte ACK = 2;
        public const byte FIN = 3;
        public const byte MSG = 4;
    }
    public enum ServiceType { // 内网＋外网，消息 
        Outer,
        Inner,
    }
    public sealed class KService: AService {
        ...
        public uint TimeNow {
            get {
                return (uint) (MonoTimeHelper.ClientNow() - this.startTime);
            }
        }
...
#region 回调方法
        ...
        public KService(ThreadSynchronizationContext threadSynchronizationContext, IPEndPoint ipEndPoint, ServiceType serviceType) {
            ...
            this.startTime = MonoTimeHelper.ClientNow();
